...
/*  Copyright 2007-2022 Patrick R. Michaud (pmichaud@pobox.com)
...
$RecipeInfo['PmForm']['Version'] = '20221123';

if ($VersionNum < 2002056)
  Abort("pmform requires pmwiki-2.2.56 or later (currently $Version)");
